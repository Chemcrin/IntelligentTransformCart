...
#define CHASSIS_COMMAND_TIMEOUT_MS        0u      /* simplified: disabled */
#define MOTOR_TIMEOUT_FAULT_LIMIT         0u      /* simplified: communication timeout is diagnostic only */

/* Straight-line closed-loop controller. The controller is called by
 * ChassisControl_PeriodicTask() at CHASSIS_CTRL_PERIOD_MS.
 * It keeps forward/backward commands straight by adding a small wz correction.
 */
#define STRAIGHT_CONTROL_ENABLE_DEFAULT   0u
#define STRAIGHT_CONTROL_MIN_SPEED_MPS    0.03f
#define STRAIGHT_CONTROL_VX_EPS_MPS       0.01f
#define STRAIGHT_CONTROL_WZ_EPS_RADPS     0.01f
#define STRAIGHT_CONTROL_MAX_WZ_RADPS     0.40f
#define STRAIGHT_CONTROL_YAW_DEADBAND_RAD 0.0087f
#define STRAIGHT_CONTROL_LR_DEADBAND_RPM  2.0f
#define STRAIGHT_YAW_KP                   1.20f
#define STRAIGHT_YAW_KI                   0.05f
#define STRAIGHT_YAW_KD                   0.02f
#define STRAIGHT_LR_KP                    0.0010f
#define STRAIGHT_LR_KI                    0.0001f
#define STRAIGHT_LR_KD                    0.0000f
#define STRAIGHT_LR_MAX_WZ_RADPS          0.10f
#define STRAIGHT_LR_CORRECTION_SIGN       1.0f
