...
| 主要风险 | 需要按实车确认目标芯片、USART3 引脚、RS485 方向脚和四轮电机方向 |
...
| 2 | 在 `.ioc` 中按 `Docs/CubeIDE导入与IOC配置.md` 配置 I2C1、USART3 和 RS485 方向 GPIO |
...
| 7 | 编译、下载前先架空车轮，确认四轮方向和 RS485 收发方向 |
...
| GPIO 输出 | PB1，推挽输出 | RS485 DE/RE 方向控制 |
